...
public class Browser {
  ...
  public void connectToInternet() {
    ...
    internet.add(google);
    Webpage squridle = new Webpage("Squirdle", "Who's that Pokemon?");
    internet.add(squridle);
    Webpage jonesBBQAndFootMassage = new Webpage("Jones BBQ and Foot Massage", "Call (708) 224-6191 for Jones BBQ and Foot Massage");
    internet.add(jonesBBQAndFootMassage);
  }
